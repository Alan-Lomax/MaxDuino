...
/******************************************************************************
   ...
   which the Arduino decodes and maintains bin counters for distinct packets
   which is output to the serial monitor (A simple form of packet sniffer).
   
   Hardware assumptions:
      MAXDuino PCB R1.2 with DCC decoder circuitry in place. (inputs to pin D5)
      Arduino NANO
