...
Modifed by AL to include basic information on the debug console. 
I always do this at 19.2K to avoid future guessing.
...
void testdrawcircle(void) {
  Serial.println(F("testdrawcircle()"));
  display.clearDisplay();
...
void testfillcircle(void) {
  Serial.println(F("testfillcircle()"));
  display.clearDisplay();
...
void testdrawroundrect(void) {
  Serial.println(F("testdrawroundrect()"));
  display.clearDisplay();
...
void testfillroundrect(void) {
  Serial.println(F("testfillroundrect()"));
  display.clearDisplay();
...
void testdrawtriangle(void) {
  Serial.println(F("testdrawtriangle()"));
  display.clearDisplay();
...
void testfilltriangle(void) {
  Serial.println(F("testfilltriangle()"));
  display.clearDisplay();
...
void testanimate(const uint8_t *bitmap, uint8_t w, uint8_t h) {
  Serial.println(F("testanimate()"));
  int8_t f, icons[NUMFLAKES][3];

  // Initialize 'snowflake' positions
  Serial.println(F("Initial Snowflakes Positions"));
...
*/
  ...
  // copyright
  Serial.println(">");
  Serial.println(F(">    From Adafruit Library. Alan Lomax (MERG M8640) 2023"));
  Serial.println(">");
}
